...
for j in range(rlz):
	...
	E_dns, k_dns = get_energy_spectrum(0.5*field_exact_dns[-1,-1,1,:]**2/ \
										field_exact_dns[-1,-1,0,:]**2, Nx_dns)
	E_iles, k_iles = get_energy_spectrum(0.5*field_iles[-1,-1,1,:]**2/ \
										field_iles[-1,-1,0,:]**2, Nx)
	E_les, k_les = get_energy_spectrum(0.5*field[-1,-1,1,:]**2/ \
										field[-1,-1,0,:]**2, Nx)
